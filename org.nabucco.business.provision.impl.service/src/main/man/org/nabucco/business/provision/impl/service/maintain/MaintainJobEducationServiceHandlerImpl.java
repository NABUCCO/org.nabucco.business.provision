...
/**
 * 
 * MaintainJobEducationServiceHandlerImpl
 * 
 * @author Dominic Trumpfheller, PRODYNA AG
 */
public class MaintainJobEducationServiceHandlerImpl extends MaintainJobEducationServiceHandler {
    ...
    @Override
    protected JobEducationMsg maintainJobEducation(JobEducationMsg msg) throws MaintainException {

        ProvisionCharacteristicMaintainServiceSupport support = new ProvisionCharacteristicMaintainServiceSupport(
                getPersistenceManager());
        JobEducation jobEducation = (JobEducation) support.maintain(msg.getJobEducation());
