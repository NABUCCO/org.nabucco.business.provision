...
/**
 * 
 * MaintainWorkExperienceServiceHandlerImpl
 * 
 * @author Dominic Trumpfheller, PRODYNA AG
 */
public class MaintainWorkExperienceServiceHandlerImpl extends MaintainWorkExperienceServiceHandler {
    ...
    @Override
    protected WorkExperienceMsg maintainWorkExperience(WorkExperienceMsg msg) throws MaintainException {

        ProvisionCharacteristicMaintainServiceSupport support = new ProvisionCharacteristicMaintainServiceSupport(
                getPersistenceManager());
        WorkExperience workExperience = (WorkExperience) support.maintain(msg.getWorkExperience());
