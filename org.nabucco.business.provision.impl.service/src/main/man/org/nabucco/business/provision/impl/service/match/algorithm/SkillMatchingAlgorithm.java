 ...
 * 
 * The algorithm to match skills
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public interface SkillMatchingAlgorithm {

    /**
     * Matches the given skills according on referenced skills
     * 
     * @param requiredSkills
     *            the skills to use as requirement
     * @param presentSkillSets
     *            the skill sets to match
     * @return the list of skillSets with their evaluations
     */
    List<SkillMatchGroup> match(List<SkillReference> requiredSkills, List<SkillSet> presentSkillSets)
