...
/**
 * ResolveTertiaryEducationServiceHandler<p/>Resolve Service for Provision<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-12-01
 */
public abstract class ResolveTertiaryEducationServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.business.provision.impl.service.resolve.ResolveTertiaryEducationServiceHandler";

    /** Constructs a new ResolveTertiaryEducationServiceHandler instance. */
    public ResolveTertiaryEducationServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<TertiaryEducationMsg> invoke(ServiceRequest<TertiaryEducationMsg> rq)
        ...
        try {
            ...
            msg = this.resolveTertiaryEducation(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ResolveException
     */
    protected abstract TertiaryEducationMsg resolveTertiaryEducation(TertiaryEducationMsg msg) throws ResolveException;
