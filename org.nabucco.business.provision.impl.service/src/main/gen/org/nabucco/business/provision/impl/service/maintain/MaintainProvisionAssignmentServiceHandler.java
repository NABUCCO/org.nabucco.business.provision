...
/**
 * MaintainProvisionAssignmentServiceHandler<p/>Maintain Service for Provision<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-12-01
 */
public abstract class MaintainProvisionAssignmentServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.business.provision.impl.service.maintain.MaintainProvisionAssignmentServiceHandler";

    /** Constructs a new MaintainProvisionAssignmentServiceHandler instance. */
    public MaintainProvisionAssignmentServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<ProvisionAssignmentMsg> invoke(ServiceRequest<ProvisionAssignmentMsg> rq)
        ...
        try {
            ...
            msg = this.maintainProvisionAssignment(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract ProvisionAssignmentMsg maintainProvisionAssignment(ProvisionAssignmentMsg msg)
            throws MaintainException;
