...
/**
 * MaintainFurtherEducationServiceHandler<p/>Maintain Service for Provision<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-12-01
 */
public abstract class MaintainFurtherEducationServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.business.provision.impl.service.maintain.MaintainFurtherEducationServiceHandler";

    /** Constructs a new MaintainFurtherEducationServiceHandler instance. */
    public MaintainFurtherEducationServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<FurtherEducationMsg> invoke(ServiceRequest<FurtherEducationMsg> rq)
        ...
        try {
            ...
            msg = this.maintainFurtherEducation(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract FurtherEducationMsg maintainFurtherEducation(FurtherEducationMsg msg) throws MaintainException;
