 ...
 */
public class Skill extends ProvisionCharacteristic implements Datatype {

    private static final long serialVersionUID = 1L;

    private static final ProvisionCharacteristicType CHARACTERISTICTYPE_DEFAULT = ProvisionCharacteristicType.SKILL;
     ...
     * CloneObject.
     *
     * @param clone the Skill.
     */
    protected void cloneObject(Skill clone) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Skill.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Skill.class).getAllProperties();
    }
}
