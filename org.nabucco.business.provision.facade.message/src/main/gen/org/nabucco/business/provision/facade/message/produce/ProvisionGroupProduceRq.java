...
/**
 * ProvisionGroupProduceRq<p/>Default message for ProvisionGroup datatype<p/>
 *
 * @version 1.0
 * @author Raffael Bieniek, PRODYNA AG, 2011-03-11
 */
public class ProvisionGroupProduceRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new ProvisionGroupProduceRq instance. */
    public ProvisionGroupProduceRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ProvisionGroupProduceRq.getPropertyDescriptor(AMOUNT), this.amount));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ProvisionGroupProduceRq other = ((ProvisionGroupProduceRq) obj);
        if ((this.amount == null)) {
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ProvisionGroupProduceRq.class).getAllProperties();
    }
}
